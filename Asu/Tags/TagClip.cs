...
{
    /// <summary>
    /// Representa un tag de recorte rectangular o vectorial del formato ASS.
    /// </summary>
    public class TagClip : Tag
    {
        public override string Name => "clip";
        public override AssTag Type => AssTag.Clip;
        ...
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="TagClip"/> dados sus argumentos rectangulares.
        /// </summary>
        ...
        public TagClip(double x1, double y1, double x2, double y2)
        {
            // Rectángulo.
            X1 = x1;
            Y1 = y1;
        ...
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="TagClip"/> dados sus argumentos de dibujo.
        /// </summary>
        /// <param name="scale">Escala del dibujo.</param>
        /// <param name="drawingCommands">Comandos de dibujo.</param>
        public TagClip(int scale, string drawingCommands)
        {
            // Comandos con escala.
            Scale = scale;
        ...
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="TagClip"/> en base a una cadena.
        /// </summary>
        /// <param name="texto">Cadena con el tag.</param>
        public TagClip(string texto)
        {
            var regex = new Regex(RegularExpressions.RegexTagClip);
            var match = regex.Match(texto);
            if (match.Success)
            {
                var regex2 = new Regex(RegularExpressions.RegexArgsClip);
        ...
        /// <summary>
        /// Devuelve una cadena con formato: \clip(x1,y1,x2,y2).
        /// </summary>
        ...
        /// <summary>
        /// Devuelve una cadena con formato: \clip(drawingCommands).
        /// </summary>
        ...
        /// <summary>
        /// Devuelve una cadena con formato: \clip(scale,drawingCommands).
        /// </summary>
        public string ToStringAsScaledDrawing()
        {
            return string.Format("\\{0}({1},{2})",
                Name, Scale, DrawingCommands);
        }
    }
}
